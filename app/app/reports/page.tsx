      ...
      <Card title="Report Builder" action={<Filter className="h-4 w-4 text-muted-foreground" />} delay={0.1}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <div className="flex items-end gap-2">
            <Button variant="primary" onClick={() => handleDownload('Executive_Report', format)}><FileText className="h-4 w-4" />Generate</Button>
            <Button variant="outline" onClick={() => handleDownload('Executive_Report', format)}><Download className="h-4 w-4" />Download</Button>
          </div>
        </div>
      </Card>
