...
export default function EmployeeManagementPage() {
  ...
  const handleInvite = (e: React.FormEvent) => {
    ...
    const inviteUrl = `${window.location.origin}/accept-invite?token=${token}&email=${encodeURIComponent(email)}&company=${encodeURIComponent(user?.tenant?.name || 'Vocalyze Global')}`;
    ...
    toast({ title: 'Invitation Generated!', description: `Invitation generated for ${email}.` });
  };
