...
import { useDepartments, useTenantUsers } from '@/lib/data/enterprise-hooks';
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="w-full max-w-md rounded-2xl glass-strong p-6 shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="primary" className="flex-1" disabled={!name} onClick={() => { setName(''); setDescription(''); setShowCreate(false); }}>Create Department</Button>
