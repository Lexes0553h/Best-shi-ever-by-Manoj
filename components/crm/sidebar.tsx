...
export function Sidebar({ mobileOpen, onClose }: { mobileOpen: boolean; onClose: () => void }) {
  ...
  const isAdminView = pathname.startsWith('/app/admin') || (isAdminRole && !pathname.startsWith('/app/dashboard') && !pathname.startsWith('/app/leads') && !pathname.startsWith('/app/calls'));

  const visibleItems = isAdminView ? ADMIN_NAV_ITEMS : EMPLOYEE_NAV_ITEMS;
