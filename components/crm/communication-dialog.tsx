      ...
      <DialogContent className="sm:max-w-md bg-white rounded-2xl border border-slate-200 shadow-xl">
        <DialogHeader className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-lg font-bold text-slate-900">{info.title}</DialogTitle>
              {recipientName && (
        ...
        <div className="my-2 rounded-xl border border-amber-200 bg-amber-50/60 p-4 text-xs text-amber-900">
